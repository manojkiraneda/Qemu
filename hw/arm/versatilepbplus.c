...
#define TYPE_VERSATILE_PB_SIC "versatilepb_sic1"
...
static void versatile_init(MachineState *machine, int board_id)
{
    ...
    qemu_irq pic[32];
    qemu_irq sic[32];
    DeviceState *dev, *sysctl,*mydev,*mydev2;
    SysBusDevice *busdev;
    DeviceState *pl041;
    PCIBus *pci_bus;
    NICInfo *nd;
    ...
    /*Adding my own Device*/
    /*mydev = qdev_create(NULL,"mydevice");
    busdev=SYS_BUS_DEVICE(mydev);
    qdev_init_nofail(mydev);
    sysbus_mmio_map(busdev,0,0x10005500);*/
    
    /*Adding my own Device*/
    mydev2 = qdev_create(NULL,"mydevice2");
    busdev=SYS_BUS_DEVICE(mydev2);
    qdev_init_nofail(mydev2);
    sysbus_mmio_map(busdev,0,0x10005900);
...
static const TypeInfo versatilepb_type = {
    .name = MACHINE_TYPE_NAME("versatilepb1"),
    .parent = TYPE_MACHINE,
...
static const TypeInfo versatileab_type = {
    .name = MACHINE_TYPE_NAME("versatileab1"),
    .parent = TYPE_MACHINE,
